...
export const workList = [
    {
        ...
        operatingDuty: [
            {
                id: 1,
                value: '创建并维护Web前端开发项目的代码库，使用版本控制工具（如Git）对代码进行管理；'
            },
            {
                id: 2,
                value: '与后端工程师和项目经理协作，确保Web前端开发项目的实施和实施时间表得到满足；'
            }, {
                id: 3,
                value: '跟踪并了解前端开发技术的发展，对现有项目进行维护和优化，确保Web前端开发项目的技术和开发方式保持最新和最佳；'
            }, {
                id: 4,
                value: '协助测试团队进行测试，并处理测试过程中的问题和反馈，确保网站的稳定性和可靠性；'
            }, {
                id: 5,
                value: '设计和开发Web前端组件，以便在多个项目中重复使用，提高开发效率；'
            }, {
                id: 6,
                value: '解决网站开发过程中的各种问题，包括调试代码、查找并解决错误等；'
            }, {
                id: 7,
                value: '在开发过程中，与UI设计师和产品经理合作，确保网站的外观和功能都符合设计要求和用户期望；'
            }, {
                id: 8,
                value: '编写文档和注释，以便其他开发人员能够轻松地维护和扩展网站；'
            }, {
                id: 9,
                value: '优化网站的性能和速度，以提高网站的响应速度和用户体验。'
            },
        ]
    },
    {
        ...
        operatingDuty: [
            {
                id: 1,
                value: '设计和开发具有高可用性和可访问性的网站，确保网站的用户界面具有良好的用户体验；'
            },
            {
                id: 2,
                value: '使用HTML、CSS和JavaScript等技术编写高质量的代码，确保网站能够在各种不同的设备和浏览器上正确显示和运行；'
            },
            {
                id: 3,
                value: '与后端开发人员协作，确保网站能够正确地与服务器进行通信和交互；'
            },
            {
                id: 4,
                value: '使用React和Vue.js等框架开发网站前端，以提高网站的开发效率和代码质量；'
            },
            {
                id: 5,
                value: '对网站进行测试和调试，确保网站的稳定性和安全性；'
            },
            {
                id: 6,
                value: '解决网站开发过程中的各种问题，包括调试代码、查找并解决错误等；'
